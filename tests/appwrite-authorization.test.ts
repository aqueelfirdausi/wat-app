...
const deniedCases = [
  ...
  ["expired session", { sessionState: "expired" }, "expired_session"],
  ...
  ["wrong Team", { account, membership: { ...membership, teamId: "other_team" } }, "no_team_membership"],
  ["malformed roles", { account, membership: { ...membership, roles: "admin" } }, "malformed_membership"],
  ["non-scalar role", { account, membership: { ...membership, roles: [["admin"]] } }, "malformed_membership"],
  ["duplicate role", { account, membership: { ...membership, roles: ["admin", "admin"] } }, "ambiguous_application_role"],
